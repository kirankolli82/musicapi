...
public final class Quote {
    ...
    public Quote(
            ...
            @JsonProperty("exchange_short") String exchangeShort,
            @JsonProperty("exchange_long") String exchangeLong,
            @JsonProperty("mic_code") String micCode,
            @JsonProperty("currency") String currency,
            @JsonProperty("price") BigDecimal price,
            @JsonProperty("day_high") BigDecimal dayHigh,
            @JsonProperty("day_low") BigDecimal dayLow,
            @JsonProperty("day_open") BigDecimal dayOpen,
            @JsonProperty("52_week_high") BigDecimal week52High,
            @JsonProperty("52_week_low") BigDecimal week52Low,
            ...
            @JsonProperty("day_change") BigDecimal dayChange,
